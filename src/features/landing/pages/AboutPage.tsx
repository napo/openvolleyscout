...
export function AboutPage() {
  ...
  return (
    <div style={{ padding: 'var(--space-xl)', maxWidth: '600px', margin: '0 auto', background: 'var(--color-background)', borderRadius: 'var(--border-radius-md)', boxShadow: 'var(--shadow-md)' }}>
      ...
      <Link to="/" style={{ display: 'inline-block', padding: 'var(--space-md) var(--space-lg)', background: 'var(--color-primary)', color: 'var(--color-background)', textDecoration: 'none', borderRadius: 'var(--border-radius-sm)', fontWeight: 'var(--font-weight-medium)', transition: 'background 0.2s' }} onMouseOver={(e) => e.currentTarget.style.background = 'var(--color-secondary)'} onMouseOut={(e) => e.currentTarget.style.background = 'var(--color-primary)'}>
        Back to Home
      </Link>
    </div>
  );
